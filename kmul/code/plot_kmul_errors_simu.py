...
# plt.savefig(path2+'/plots/kmul_errL1cont.pdf',**savefig_options)
# plt.savefig(path2+'/plots/kmul_errL1cont.png',**savefig_options)
...
# plt.savefig(path2+'/plots/kmul_errL1dis.pdf',**savefig_options)
# plt.savefig(path2+'/plots/kmul_errL1dis.png',**savefig_options)
