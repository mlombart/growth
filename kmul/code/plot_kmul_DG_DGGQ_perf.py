...
plt.xlim(xmin,xmax)
plt.loglog(data_solkmulDL_tend[:,0],data_solkmulDL_tend[:,1],'--',c='C0',label='Analytic')
...
# plt.savefig(path2+'/plots/kmul_tend_loglog_xmeanlog_DGvsDGGQ.pdf',**savefig_options)
# plt.savefig(path2+'/plots/kmul_tend_loglog_xmeanlog_DGvsDGGQ.png',**savefig_options)
