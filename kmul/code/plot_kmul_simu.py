...
data_solkmulDL_t0 = np.genfromtxt(path2+'/data/list_solkmul_tau=0.csv',delimiter=",")
...
axes[0,0].plot(data_solkmulDL_t0[:,0],data_solkmulDL_t0[:,1],'--',c='C0',label='Analytic')
axes[0,1].plot(data_solkmulDL_tend[:,0],data_solkmulDL_tend[:,1],'--',c='C0',label='Analytic')
axes[1,0].plot(data_solkmulDL_t0[:,0],data_solkmulDL_t0[:,1],'--',c='C0',label='Analytic')
axes[1,1].plot(data_solkmulDL_tend[:,0],data_solkmulDL_tend[:,1],'--',c='C0',label='Analytic')
axes[2,0].plot(data_solkmulDL_t0[:,0],data_solkmulDL_t0[:,1],'--',c='C0',label='Analytic')
axes[2,1].plot(data_solkmulDL_tend[:,0],data_solkmulDL_tend[:,1],'--',c='C0',label='Analytic')
axes[3,0].plot(data_solkmulDL_t0[:,0],data_solkmulDL_t0[:,1],'--',c='C0',label='Analytic')
axes[3,1].plot(data_solkmulDL_tend[:,0],data_solkmulDL_tend[:,1],'--',c='C0',label='Analytic')
...
# plt.savefig(path2+'/plots/kmul_linlog.pdf',**savefig_options)
plt.savefig(path2+'/plots/kmul_linlog.png',**savefig_options)
