...
path_data_k2 = path2+'/data/EOC/dp/'
...
# plt.savefig(path2+'/plots/kmul_errL1cont_convergence.pdf',**savefig_options)
# plt.savefig(path2+'/plots/kmul_errL1cont_convergence.png',**savefig_options)
...
# plt.savefig(path2+'/plots/kmul_errL1dis_convergence.pdf',**savefig_options)
# plt.savefig(path2+'/plots/kmul_errL1dis_convergence.png',**savefig_options)
