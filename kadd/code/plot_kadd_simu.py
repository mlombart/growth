...
data_solkaddDL_t0 = np.genfromtxt(path2+'/data/list_solkadd_tau=0.csv',delimiter=",")
...
for (m,n), subplot in np.ndenumerate(axes):
   ...
   axes[m,n].axvline(massgridk2[0],c='grey',alpha=0.3)
...
axes[0,0].semilogx(data_solkaddDL_t0[:,0],data_solkaddDL_t0[:,1],'--',c='C0',label='Analytic')
axes[0,1].semilogx(data_solkaddDL_tend[:,0],data_solkaddDL_tend[:,1],'--',c='C0',label='Analytic')
axes[1,0].semilogx(data_solkaddDL_t0[:,0],data_solkaddDL_t0[:,1],'--',c='C0',label='Analytic')
axes[1,1].semilogx(data_solkaddDL_tend[:,0],data_solkaddDL_tend[:,1],'--',c='C0',label='Analytic')
axes[2,0].semilogx(data_solkaddDL_t0[:,0],data_solkaddDL_t0[:,1],'--',c='C0',label='Analytic')
axes[2,1].semilogx(data_solkaddDL_tend[:,0],data_solkaddDL_tend[:,1],'--',c='C0',label='Analytic')
axes[3,0].semilogx(data_solkaddDL_t0[:,0],data_solkaddDL_t0[:,1],'--',c='C0',label='Analytic')
axes[3,1].semilogx(data_solkaddDL_tend[:,0],data_solkaddDL_tend[:,1],'--',c='C0',label='Analytic')
...
axes[0,0].set_title(r'$\tau=%d$' %(timek2[0]))
axes[0,1].set_title(r'$\tau=%d$' %(timek2[-1]))
...
# plt.savefig(path2+'/plots/kadd_linlog.pdf',**savefig_options)
# plt.savefig(path2+'/plots/kadd_linlog.png',**savefig_options)
